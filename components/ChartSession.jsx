...
const ChatSession = ({ setChat, setSetting, setMessage, setViewProfile ,ViewProfile }) => {
  ...
  return (
    <>
    {
      ViewProfile ? <ViewProfileSession setViewProfile={setViewProfile} setChat={setChat}/> :  <View className="mt-[2.8rem] ">
      {/* TopBar */}
      <View className="flex h-[8vh] w-[99.9vw] flex-row items-center overflow-hidden bg-[---b1]">
        ...
        <View className="ml-[-1.5rem] flex flex-row items-center">
          <Pressable onPress={()=>{setViewProfile(true)}} className="flex flex-row items-center">
      ...
      <View
        ...
        <Pressable onPress={()=>{setViewProfile(true)}}>
