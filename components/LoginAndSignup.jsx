...
const LoginAndSignUp = () => {
  ...
  return (
    <>
    {
      Home ? <HomePage/>:<View className="my-auto items-center ">
        
      {/* Login */}
      {
        Login ? <View className="items-center">
        <View>
          <Text className="fixed top-[-8rem] text-[1.5rem] font-extrabold">Pigeon Message 🕊️</Text>
        </View>
          <Text className="my-[1rem] text-[20px] font-black">Login</Text>
          <View className="my-[1rem] w-[70vw] overflow-x-hidden  ">
            <Text
              className={`${ChangeEmail ? 'block' : 'hidden'} absolute left-5 top-[-10px] rounded-[2rem] bg-[---wt] px-1 shadow-sm`}>
              Email
            </Text>
            <TextInput
              onFocus={() => {
          ...
          <View className="my-[1rem] w-[70vw] overflow-x-hidden">
            <Text
              className={`${ChangePassword ? 'block' : 'hidden'} absolute left-5 top-[-10px] rounded-[2rem] bg-[---wt] px-1 shadow-sm`}>
              Password
            </Text>
          ...
          <View className="items-center">
            ...
            <Text className="text-[---h1] underline">Forgot Password ?</Text></Pressable>
          </View>
        </View>:null
      }
      ...
      {/* Signup */}
      {
        SignUp ? <View className="items-center">
        <View>
          <Text className="fixed top-[-2rem] text-[1.5rem] font-extrabold">Pigeon Message 🕊️</Text>
        </View>
          ...
          <View className="my-[1rem] w-[70vw] overflow-x-hidden  ">
            <Text
              className={`${ChangeName ? 'block' : 'hidden'} absolute left-5 top-[-10px] rounded-[2rem] bg-[---wt] px-1 shadow-sm`}>
              Name
            </Text>
            <TextInput
              onFocus={() => {
          ...
          <View className="my-[1rem] w-[70vw] overflow-x-hidden  ">
            <Text
              className={`${ChangeBD ? 'block' : 'hidden'} absolute left-5 top-[-10px] rounded-[2rem] bg-[---wt] px-1 shadow-sm`}>
              Date Of Birth
            </Text>
            <TextInput
              onFocus={() => {
          ...
          <View className="my-[1rem] w-[70vw] overflow-x-hidden  ">
            <Text
              className={`${ChangePhone ? 'block' : 'hidden'} absolute left-5 top-[-10px] rounded-[2rem] bg-[---wt] px-1 shadow-sm`}>
              Phone
            </Text>
              <TextInput
              onFocus={() => {
        ...
        {/* Forgot */}
        {
          Forgot ? <View className="items-center">
          <View>
            <Text className="fixed top-[-12rem] text-[1.5rem] font-extrabold">Pigeon Message 🕊️</Text>
          </View>
